...
/* ==========================================================================
  ...
  $(document).ready(function() {
    ...
    // Throbber loading plugin

    var throbberContainer = document.getElementsByClassName('throbber-container'),
        throbber = Throbber({
          color: "#000",
          size: 100,
          fade: 200
    ...
    if(throbberContainer.length) {
      throbber.appendTo(throbberContainer[0]).start();
    }
    ...
    if(typeof $.fn.revolution !== 'undefined'){
      ...
      if($fullWidthBanner.length){
        $fullWidthBanner.bind("revolution.slide.onloaded",function (e) {
          throbber.stop();
          $fullWidthBanner.css('visibility', 'visible');
        });
      }
